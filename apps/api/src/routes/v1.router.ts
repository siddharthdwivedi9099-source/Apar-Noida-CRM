...
import { createCustomerPortalRouter } from "../modules/customer-portal/customer-portal.router.js";
...
export function createV1Router({
  ...
  router.use("/customer-portal", createCustomerPortalRouter({ databaseService }));
